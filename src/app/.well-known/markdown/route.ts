...
export async function GET() {
  ...
  const lines = [
    ...
    "",
    "BrainFit Karşıyaka, çocuklar ve yetişkinler için bilişsel becerileri anlamaya ve kişiye özel gelişim planı oluşturmaya yardımcı olan CogMap bilimsel değerlendirmesi sunar.",
    "",
    "## CogMap",
    "",
